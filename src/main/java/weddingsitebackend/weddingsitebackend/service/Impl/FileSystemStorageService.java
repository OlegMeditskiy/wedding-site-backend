...
import weddingsitebackend.weddingsitebackend.storage.StorageException;
...
public class FileSystemStorageService implements StorageService {
    ...
    @Override
    public String saveAsString(MultipartFile file, String name) {
        String[] tokens = file.getOriginalFilename().split("\\.(?=[^\\.]+$)");
        String filename = name+"."+tokens[1];
//        String filename = StringUtils.cleanPath(Objects.requireNonNull(file.getOriginalFilename()));
        try {
    ...
    public void delete(String filename) throws IOException {
        File file = new File(String.valueOf(load(filename)));
